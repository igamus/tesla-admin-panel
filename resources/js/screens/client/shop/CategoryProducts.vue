                        ...
                        <template>
                            <v-btn
                                @click ="() => {
                                    ...
                                    $router.push({name: 'CategoryProducts', query: { category: categoryItem }});
                                }"
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12"  v-for="product in category.products" :key="product.id">
                            <v-hover v-slot:default ="{ hover }">
                                <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                                    <v-img class="white--text align-end" :aspect-ratio="16/9" height="200px" :src="'/products/'+product.image">
                                        <v-expand-transition>
                                    ...
                                    <v-card-text class="text--primary" style="margin-button:-8px">
                                        {{ product.name }}
                                    </v-card-text>
